...
<table border="1" cellpadding="2"> 
    <tr class="alert alert-success">  
        <td style="width: 130px;" align="center"><h6></h6></td> 
        <td style="width: 90px;" align="center"><h6></h6></td>
        <td style="width: 80px;" align="center"><h6></h6></td>
        <td style="width: 90px;" align="center"><h6></h6></td> 
        <td style="width: 80px;" align="center"><h6></h6></td>
        <td style="width: 70px;" align="center"><h6></h6></td>
        <td style="width: 233px;" align="center"><h6></h6></td>
    </tr>
</table>
