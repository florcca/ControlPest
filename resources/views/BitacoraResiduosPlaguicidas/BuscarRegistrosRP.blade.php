...
@section('titulo')
Buscar registro en residuos de plaguicidas
@endsection
@section('contenido')
  ...
  <table class="table table-bordered table-striped">
    <thead>
      <tr>
        ...
        <center><th style="width:22%" nowrap>No. de producto</th></center>
        <center><th style="width:15%" nowrap>Cantidad de desechos</th></center>
        <center><th style="width:12%" nowrap>Destino final</th></center>
        <center><th style="width:12%" nowrap>Observaciones</th></center>
