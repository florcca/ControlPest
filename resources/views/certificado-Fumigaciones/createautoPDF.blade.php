...
<table border="0" cellpadding="0"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 410px;" align="left"><h2>Erick Aram Del Real Miramontes Villarreal Haro</h2></td> 
    </tr>
</table>
<table border="0" cellpadding="1"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 410px;" align="left"><h2>Concepción del oro # 12</h2></td> 
    </tr>
</table>
<table border="0" cellpadding="1"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 410px;" align="left"><h2>Tepechitlán, Zac.</h2></td> 
    </tr>
</table>
<table border="0" cellpadding="1"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 410px;" align="left"><h2>Centro Cristiano La Vid Verdadera A.R.</h2></td> 
    </tr>
</table>
...
<table border="0"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 410px;" align="left"><h2>Nissan Versa 2018</h2></td> 
    </tr>
</table>
<table border="0" cellpadding="1"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 140px;" align="left"><h2>ZFR-98-12</h2></td>
        <td style="width: 150px;" align="left"><h2>Giro del vehículo: </h2></td> 
        <td style="width: 410px;" align="left"><h2>Información desconocida</h2></td> 
    </tr>
</table>
<table border="0" cellpadding="1"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 410px;" align="left"><h2>Baygon con Raid más Rimetifizaderex</h2></td> 
    </tr>
</table>
<table border="0" cellpadding="1"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 100px; background-color:#F8EF89;color:#1A1501;" align="center" border="0"><h2>12/12/18</h2></td> 
        <td style="width: 35px;" align="center"></td> 
        <td style="width: 190px;" align="left"><h2>Fecha de vencimiento: </h2></td> 
        <td style="width: 100px; background-color:#F8EF89;color:#1A1501;" align="center" border="0"><h2>12/12/19</h2></td> 
    </tr>
</table>
...
<table border="0" cellpadding="5"> 
    <tr class="alert alert-success"> 
        ...
        <td style="width: 15px;" align="left"></td>
        <td style="width: 290px; background-color:#F8EF89;color:#1A1501;" align="left"><h3>Nombre: Flor Carolina Castañeda Arteaga</h3></td>
        <td style="width: 15px;" align="left"></td>
